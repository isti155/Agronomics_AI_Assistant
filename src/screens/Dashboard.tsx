    ...
    const fetchDailyTip = async () => {
      ...
      if (!apiKey) {
        ...
        const fallback = {
          ...
          desc: language === 'bn' 
            ? 'ধান কাটার পর দ্রুত মাড়াই করে রোদে শুকিয়ে নিন। আর্দ্রতা ১২-১৪% এর নিচে রাখা জরুরি।' 
      ...
      try {
        ...
        setTip({
          ...
          desc: language === 'bn' ? 'সুষম সার ব্যবহার করুন এবং জৈব সারের পরিমাণ বাড়ান।' : 'Use balanced fertilizers and increase organic manure usage.',
